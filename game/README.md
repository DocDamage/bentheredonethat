...
Automated scenes live in `tests`. The current suite contains 46 smoke tests covering boot flow, movement, controllers, authored world collision footprints, collision-free field followers, town construction, conventional Armory buying/selling/comparisons, services, NPC routines, sandbox editing, universe scenarios, quests, seven persistent save points, five persistent exploration caches, roster management, jobs, encounter pressure, combat depth, persistent bestiary and monster recruitment, supplied character animation/UI/VFX/SFX, and asset slicing.
