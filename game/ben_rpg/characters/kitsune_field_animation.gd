@tool
class_name KitsuneFieldAnimation
extends GamepieceAnimation

const FRAME_RATE := 7.0
const FRAME_COUNT := 4
const ASSET_ROOT := "res://game_assets/characters/Recruitable Characters/kitsune empress"
...
func _update_texture() -> void:
	...
	if direction == Directions.Points.WEST:
		...
		facing = "east"
	var path := "%s/animations/Breathing_Idle-5abb96ca/%s/frame_%03d.png" % [ASSET_ROOT, facing, _frame]
