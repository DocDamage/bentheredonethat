@tool
class_name MossbackSurveyorFieldAnimation
extends GamepieceAnimation

const FRAME_RATE := 8.0
const ASSET_ROOT := "res://game_assets/characters/Topdown Monsters Part 1/Sliced/Mossback Surveyor"
const SEQUENCES := {
...
func _ready() -> void:
	...
	# The ogre is broad, but should still read as a field character rather than
	# a battle-sized prop pasted onto the map.
