...
static func action(action_id: StringName) -> Dictionary:
	var actions := {
		...
		&"spectral_touch": {"name": "Spectral Touch", "kind": "magic", "power": 13, "target": "ally", "element": &"spectral", "status": &"slow", "status_chance": 0.4, "description": "Cold fingers pass through armor and may inflict Slow."},
		&"hurl_volume": {"name": "Hurl Volume", "kind": "physical", "power": 15, "target": "ally", "description": "Knowledge is power, especially at high velocity."},
		&"ink_blight": {"name": "Ink Blight", "kind": "magic", "power": 10, "target": "ally", "element": &"spectral", "status": &"poisoned", "status_chance": 0.7, "description": "Cursed ink harms and poisons one target."},
		&"steal_time": {"name": "Steal Time", "kind": "damage_delay", "power": 10, "delay": 24, "target": "ally", "element": &"time", "status": &"slow", "status_chance": 0.55, "description": "The clock wounds a target, drains ATB, and may inflict Slow."},
		...
		&"splinter_needle": {"name": "Splinter Needle", "kind": "physical", "power": 18, "target": "ally", "status": &"poisoned", "status_chance": 0.42, "description": "A toy needle strikes one target and may inflict Poison."},
		...
		&"heavenly_aegis": {"name": "Heavenly Command", "kind": "rally", "power": 5, "mp": 6, "target": "all_allies", "description": "The Archangel's command raises the formation's attack."},
		...
		&"servo_strike": {"name": "Servo Strike", "kind": "physical", "power": 20, "target": "ally", "description": "A machine-driven blow."},
		...
		&"system_shock": {"name": "System Shock", "kind": "magic", "power": 20, "target": "ally", "element": &"lightning", "status": &"shocked", "status_chance": 0.5, "description": "A hostile diagnostic pulse shocks one target."},
		...
		&"prehistoric_bite": {"name": "Prehistoric Bite", "kind": "physical", "power": 22, "target": "ally", "description": "Several million years of dentistry become immediately relevant."},
		...
		&"compliance_burst": {"name": "Compliance Burst", "kind": "physical", "power": 22, "target": "ally", "status": &"slow", "status_chance": 0.35, "description": "A precision burst strongly recommends immediate cooperation."},
		&"daylight_lance": {"name": "Daylight Lance", "kind": "magic", "power": 25, "target": "ally", "element": &"radiant", "status": &"shocked", "status_chance": 0.4, "description": "Concentrated municipal sunlight overloads one target."},
		...
		&"cold_assessment": {"name": "Cold Assessment", "kind": "magic", "power": 28, "target": "ally", "element": &"frost", "status": &"slow", "status_chance": 0.48, "description": "A collector estimates one target's taxable body heat."},
		&"lien_of_silence": {"name": "Lien of Silence", "kind": "damage_delay", "power": 23, "delay": 34, "target": "ally", "element": &"spectral", "status": &"slow", "status_chance": 0.42, "description": "A spectral lien harms one target and freezes part of its ATB gauge."},
		...
		&"memory_stamp": {"name": "Memory Stamp", "kind": "magic", "power": 30, "target": "ally", "element": &"spectral", "status": &"slow", "status_chance": 0.46, "description": "An inspector replaces one recollection with a slower, officially approved copy."},
		...
		&"gravity_writ": {"name": "Writ of Excess Weight", "kind": "damage_delay", "power": 29, "delay": 30, "target": "ally", "element": &"radiant", "status": &"slow", "status_chance": 0.48, "description": "A celestial writ increases one target's legal and physical burden."},
	...
	return actions.get(action_id, {}).duplicate(true)
...
static func enemy_actor(enemy_id: StringName, index: int) -> Dictionary:
	var catalog := {
		...
		&"civic_sun": {"name": "Civic Sun, Acting Mayor", "hp": 1950, "attack": 47, "defense": 41, "magic": 48, "spirit": 37, "speed": 34, "sprite": "CP_G56_Guardian.png", "actions": [&"permanent_noon", &"daylight_lance", &"suppressive_burst"], "elements": {&"lightning": 0.7, &"frost": 1.3}, "status_resist": {&"poisoned": 1.0, &"slow": 0.6, &"shocked": 0.45}, "exp": 460, "duckets": 190, "pack": SCI_FI_PACK},
		&"cobalt_courier_challenger": {"name": "Cobalt Courier, Undeliverable Agent", "hp": 2180, "attack": 50, "defense": 38, "magic": 52, "spirit": 40, "speed": 57, "sprite_path": "res://game_assets/characters/Topdown Monsters Part 1/Sliced/Cobalt Courier/00_idle/frame_000.png", "actions": [&"cobalt_claw", &"express_jolt", &"priority_delivery"], "elements": {&"lightning": 0.3, &"frost": 1.3, &"spectral": 1.15}, "status_resist": {&"poisoned": 0.7, &"slow": 0.5, &"shocked": 0.25}, "exp": 420, "duckets": 165, "battle_animation_root": "res://game_assets/characters/Topdown Monsters Part 1/Sliced/Cobalt Courier", "battle_animation_fps": 8.0, "battle_animation_sequences": {&"idle": {"folder": "00_idle", "frames": 6}, &"attack": {"folder": "05_attack", "frames": 6}, &"hit": {"folder": "06_hit", "frames": 6}, &"power": {"folder": "08_blast_attack_2", "frames": 6}, &"victory": {"folder": "02_victory", "frames": 8}, &"death": {"folder": "12_death_1", "frames": 8}}, "battle_action_sequences": {&"cobalt_claw": &"attack", &"express_jolt": &"power", &"priority_delivery": &"attack"}},
		&"frost_collector": {"name": "Royal Heat Collector", "hp": 315, "attack": 43, "defense": 34, "magic": 31, "spirit": 29, "speed": 31, "sprite": "CP_J56_WaterClubWarrior.png", "actions": [&"cold_assessment", &"servo_strike"], "elements": {&"frost": 0.45, &"radiant": 1.25, &"lightning": 1.15}, "exp": 116, "duckets": 47, "pack": VILLAIN_PACK},
		&"frost_necromancer": {"name": "Permafrost Assessor", "hp": 265, "attack": 27, "defense": 25, "magic": 46, "spirit": 38, "speed": 36, "sprite": "CP_J33_DarkNecromancer.png", "actions": [&"lien_of_silence", &"cold_assessment"], "elements": {&"frost": 0.35, &"radiant": 1.35}, "exp": 124, "duckets": 51, "pack": VILLAIN_PACK},
		...
		&"whiteout_auditor": {"name": "Whiteout Auditor, Crown Receiver", "hp": 2450, "attack": 54, "defense": 46, "magic": 57, "spirit": 43, "speed": 37, "sprite": "CP_J60_ElementalFusionDragon.png", "actions": [&"absolute_audit", &"lien_of_silence", &"cold_assessment"], "elements": {&"frost": 0.2, &"radiant": 1.25, &"lightning": 1.2}, "status_resist": {&"poisoned": 1.0, &"slow": 0.65, &"shocked": 0.5}, "exp": 590, "duckets": 245, "pack": VILLAIN_PACK},
		...
		&"fox_attendant": {"name": "Counterfeit Wedding Attendant", "hp": 310, "attack": 46, "defense": 30, "magic": 37, "spirit": 31, "speed": 45, "sprite": "CP_A204_FoxWeddingAttendant.png", "actions": [&"procession_waltz", &"memory_stamp"], "elements": {&"spectral": 0.5, &"frost": 1.2, &"lightning": 1.15}, "exp": 150, "duckets": 61, "pack": YOKAI_PACK},
		...
		&"magistrate_enma": {"name": "Magistrate Enma, Keeper of the False Moon", "hp": 2920, "attack": 58, "defense": 49, "magic": 63, "spirit": 48, "speed": 40, "sprite": "CP_A210_Enma.png", "actions": [&"final_testimony", &"procession_waltz", &"memory_stamp"], "elements": {&"spectral": 0.25, &"lightning": 1.3, &"radiant": 1.2}, "status_resist": {&"poisoned": 1.0, &"slow": 0.7, &"shocked": 0.55}, "exp": 720, "duckets": 310, "pack": YOKAI_PACK},
		&"crimson_oni_challenger": {"name": "Crimson Oni, Blood-Moon Challenger", "hp": 2650, "attack": 62, "defense": 45, "magic": 24, "spirit": 39, "speed": 51, "sprite_path": "res://game_assets/characters/Recruitable Characters/crimson oni samurai/rotations/west.png", "actions": [&"oni_crescent", &"blood_moon_cleave"], "elements": {&"spectral": 0.55, &"frost": 1.25, &"lightning": 1.15}, "status_resist": {&"poisoned": 0.8, &"slow": 0.55, &"shocked": 0.45}, "exp": 680, "duckets": 280},
		&"wind_bailiff": {"name": "Wind Bailiff", "hp": 390, "attack": 51, "defense": 38, "magic": 45, "spirit": 40, "speed": 49, "sprite": "CP_J31_WindFighter.png", "actions": [&"gravity_writ", &"compliance_burst"], "elements": {&"radiant": 0.65, &"frost": 1.25, &"lightning": 1.15}, "exp": 172, "duckets": 70, "pack": VILLAIN_PACK},
		&"storm_repossessor": {"name": "Storm-Wing Repossessor", "hp": 420, "attack": 48, "defense": 36, "magic": 55, "spirit": 42, "speed": 43, "sprite": "CP_J32_StormWingFighter.png", "actions": [&"storm_decree", &"gravity_writ"], "elements": {&"lightning": 0.35, &"frost": 1.2}, "exp": 184, "duckets": 75, "pack": VILLAIN_PACK},
		&"fallen_notary": {"name": "Fallen Miracle Notary", "hp": 455, "attack": 34, "defense": 35, "magic": 61, "spirit": 48, "speed": 36, "sprite": "CP_J49_FallenNobleMage.png", "actions": [&"gravity_writ", &"daylight_lance"], "elements": {&"radiant": 0.45, &"spectral": 1.25}, "exp": 196, "duckets": 81, "pack": VILLAIN_PACK},
		&"gravity_knight": {"name": "Elemental Lien Knight", "hp": 690, "attack": 60, "defense": 54, "magic": 45, "spirit": 44, "speed": 28, "sprite": "CP_J37_ElementalFusionKnight.png", "actions": [&"storm_decree", &"gravity_writ"], "elements": {&"lightning": 0.55, &"spectral": 1.2}, "exp": 238, "duckets": 96, "pack": VILLAIN_PACK},
		&"high_comptroller": {"name": "High Comptroller of Gravity", "hp": 3560, "attack": 64, "defense": 55, "magic": 70, "spirit": 54, "speed": 43, "sprite": "CP_J59_StormCommander.png", "actions": [&"foreclosure_of_flight", &"storm_decree", &"gravity_writ"], "elements": {&"lightning": 0.25, &"spectral": 1.25}, "status_resist": {&"poisoned": 1.0, &"slow": 0.72, &"shocked": 0.58}, "exp": 860, "duckets": 370, "pack": VILLAIN_PACK},
	}
...
static func encounter(encounter_id: StringName) -> Dictionary:
	...
	return encounters.get(encounter_id, encounters[&"mansion_restless_books"]).duplicate(true)
