...
func _draw() -> void:
	...
	match active_area:
		...
		&"primeval_nest":
			...
			_prop(trees, Rect2(665, 450, 132, 176), room_offset + Vector2(310, 28), 0.5)
			_profile_prop(&"primeval_relay_nest", nests, room_offset + Vector2(148, 54))
			_prop(nests, Rect2(19, 454, 170, 134), room_offset + Vector2(14, 124), 0.5)
			_prop(nests, Rect2(391, 448, 172, 142), room_offset + Vector2(286, 120), 0.5)
			_prop(trees, Rect2(49, 665, 105, 80), room_offset + Vector2(74, 146), 0.5)
			_prop(trees, Rect2(1125, 664, 108, 82), room_offset + Vector2(270, 146), 0.5)
			_prop(props, Rect2(689, 4, 65, 190), room_offset + Vector2(104, 73), 0.5)
		&"primeval_caldera":
