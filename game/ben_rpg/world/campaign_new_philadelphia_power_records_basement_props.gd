class_name CampaignNewPhiladelphiaPowerRecordsBasementProps
extends Node2D
const PROFILES := preload("res://ben_rpg/world/campaign_visual_profile_registry.gd")
const PLACEMENTS := [[Vector2i(4, 5), &"laboratory_west_storage"], [Vector2i(13, 5), &"laboratory_east_generator"], [Vector2i(4, 11), &"laboratory_analysis_station"], [Vector2i(14, 11), &"laboratory_center_storage"], [Vector2i(9, 8), &"laboratory_east_reactor"]]
var _profiles
