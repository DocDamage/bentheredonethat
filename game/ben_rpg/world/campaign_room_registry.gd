...
static func room(room_id: StringName) -> Dictionary:
	...
	elif room_id == &"FR-06": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_lien_device_hall.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"]},true)
	elif room_id == &"FR-07": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_rune_throne_approach.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"]},true)
	...
	elif room_id == &"EM-03": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_garden_appeals.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"]},true)
	...
	elif room_id == &"EM-05": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_counterweight_lift_station.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne"],"featureIds":[&"aerie_seal"]},true)
