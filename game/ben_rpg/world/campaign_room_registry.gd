...
static func room(room_id: StringName) -> Dictionary:
	...
	elif room_id == &"HE-03": definition.merge({"scenePath":"res://ben_rpg/world/rooms/helios_public_market.tscn","worldOrigin":Vector2i(450,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"heliosInteractions":[{"nodeName":"HeliosOrdinanceTerminal","kind":&"ordinance_terminal","cell":Vector2i(16,6)}]},true)
	...
	elif room_id == &"HE-05": definition.merge({"scenePath":"res://ben_rpg/world/rooms/helios_transit_phase_substation.tscn","worldOrigin":Vector2i(450,0),"enabledPortIds":[&"Nw"],"heliosInteractions":[{"nodeName":"HeliosTransitNode","kind":&"transit_node","cell":Vector2i(9,7)}]},true)
	...
	elif room_id == &"HE-06": definition.merge({"scenePath":"res://ben_rpg/world/rooms/helios_clinic.tscn","worldOrigin":Vector2i(450,0),"enabledPortIds":[&"Nw",&"Ne"],"heliosInteractions":[{"nodeName":"HeliosSaveBeacon","kind":&"save_beacon","cell":Vector2i(8,10)},{"nodeName":"HeliosClinicNode","kind":&"clinic_node","cell":Vector2i(12,10)}]},true)
	...
	elif room_id == &"FR-03": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_frozen_market.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"frostholdInteractions":[{"nodeName":"FrostholdHeatTaxRune","kind":&"heat_tax_rune","cell":Vector2i(16,6)}]},true)
	...
	elif room_id == &"FR-05": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_first_thermal_lien.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne"],"frostholdInteractions":[{"nodeName":"FrostholdCausewaySeal","kind":&"causeway_seal","cell":Vector2i(9,8)}]},true)
	elif room_id == &"FR-06": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_lien_device_hall.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"frostholdInteractions":[{"nodeName":"FrostholdSaveBrazier","kind":&"save_brazier","cell":Vector2i(12,11)}]},true)
	elif room_id == &"FR-07": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_rune_throne_approach.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"frostholdInteractions":[{"nodeName":"FrostholdThroneSeal","kind":&"throne_seal","cell":Vector2i(10,8)}]},true)
	elif room_id == &"FR-08": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_white_court_chamber.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne"],"featureIds":[&"frosthold_white_court_boss"]},true)
	elif room_id == &"FR-09": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_lower_village_hearthline.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne"],"featureIds":[&"hearthline_relief"]},true)
	elif room_id == &"FR-10": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_crystalice_forest.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne"],"featureIds":[&"whiteout_safe_trail"]},true)
	elif room_id == &"FR-11": definition.merge({"scenePath":"res://ben_rpg/world/rooms/frosthold_blueglass_ice_cavern.tscn","worldOrigin":Vector2i(500,0),"enabledPortIds":[&"Nw",&"Ne"],"featureIds":[&"reflection_latch"]},true)
	...
	elif room_id == &"MP-06": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_bell_walk.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"featureIds":[&"fox_procession_ambush"],"moonpetalInteractions":[{"nodeName":"MoonpetalSaveLantern","kind":&"save_lantern","cell":Vector2i(8,11)}]},true)
	...
	elif room_id == &"EM-03": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_garden_appeals.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"empyrealInteractions":[{"nodeName":"EmpyrealGravityOrdinance","kind":&"gravity_ordinance","cell":Vector2i(16,6)}]},true)
	...
	elif room_id == &"EM-07": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_reliquary_aerie.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2",&"Se"],"featureIds":[&"repossession_ambush"],"empyrealInteractions":[{"nodeName":"EmpyrealSaveFountain","kind":&"save_fountain","cell":Vector2i(11,11)}]},true)
