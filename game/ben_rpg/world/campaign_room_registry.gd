...
static func room(room_id: StringName) -> Dictionary:
	...
	if room_id == &"HE-01": definition.merge({"scenePath":"res://ben_rpg/world/rooms/helios_afterlight_skybridge.tscn","worldOrigin":Vector2i(450,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:he01-afterlight-skybridge-navigation","collisionMaskId":&"authored:he01-afterlight-skybridge-collision","navigationLayout":{"id":&"he01-afterlight-skybridge-v1","kind":&"authored","usefulCellRange":Vector2i(247,248),"walkableRects":[{"origin":Vector2i(6,1),"size":Vector2i(12,4)},{"origin":Vector2i(3,4),"size":Vector2i(18,10)},{"origin":Vector2i(20,5),"size":Vector2i(3,4)},{"origin":Vector2i(6,13),"size":Vector2i(12,3)}]}},true)
	...
	elif room_id == &"MP-01": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_vermilion_gate_terrace.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:mp01-vermilion-gate-terrace-navigation","collisionMaskId":&"authored:mp01-vermilion-gate-terrace-collision","navigationLayout":{"id":&"mp01-vermilion-gate-terrace-v1","kind":&"authored","usefulCellRange":Vector2i(347,347),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(22,16)}]}},true)
	elif room_id == &"MP-02": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_blossom_court.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"navigationId":&"authored:mp02-blossom-court-navigation","collisionMaskId":&"authored:mp02-blossom-court-collision","navigationLayout":{"id":&"mp02-blossom-court-v1","kind":&"authored","usefulCellRange":Vector2i(380,380),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(24,16)}]},"moonpetalInteractions":[{"nodeName":"MoonpetalVowTablet","kind":&"vow_tablet","cell":Vector2i(16,6)}]},true)
	elif room_id == &"MP-03": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_lantern_arcade.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"navigationId":&"authored:mp03-lantern-arcade-navigation","collisionMaskId":&"authored:mp03-lantern-arcade-collision","navigationLayout":{"id":&"mp03-lantern-arcade-v1","kind":&"authored","usefulCellRange":Vector2i(236,236),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(20,12)}]}},true)
	elif room_id == &"MP-04": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_mirror_garden_outer_walk.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:mp04-mirror-garden-outer-walk-navigation","collisionMaskId":&"authored:mp04-mirror-garden-outer-walk-collision","navigationLayout":{"id":&"mp04-mirror-garden-outer-walk-v1","kind":&"authored","usefulCellRange":Vector2i(391,391),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(22,18)}]},"universeTreasures":[{"nodeName":"MoonpetalGardenTreasure","cacheId":&"moonpetal_offering","cell":Vector2i(12,8)}]},true)
	elif room_id == &"MP-05": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_counterfeit_vow_pavilion.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:mp05-counterfeit-vow-pavilion-navigation","collisionMaskId":&"authored:mp05-counterfeit-vow-pavilion-collision","navigationLayout":{"id":&"mp05-counterfeit-vow-pavilion-v1","kind":&"authored","usefulCellRange":Vector2i(186,186),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(16,12)}]},"featureIds":[&"garden_seal"],"moonpetalInteractions":[{"nodeName":"MoonpetalGardenSeal","kind":&"garden_seal","cell":Vector2i(9,8)}]},true)
	elif room_id == &"MP-06": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_bell_walk.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:mp06-bell-walk-navigation","collisionMaskId":&"authored:mp06-bell-walk-collision","navigationLayout":{"id":&"mp06-bell-walk-v1","kind":&"authored","usefulCellRange":Vector2i(379,379),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(24,16)}]},"featureIds":[&"fox_procession_ambush"],"moonpetalInteractions":[{"nodeName":"MoonpetalSaveLantern","kind":&"save_lantern","savePointId":&"moonpetal_bell_walk","cell":Vector2i(8,11)}]},true)
	elif room_id == &"MP-07": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_moon_palace_approach.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E2"],"navigationId":&"authored:mp07-moon-palace-approach-navigation","collisionMaskId":&"authored:mp07-moon-palace-approach-collision","navigationLayout":{"id":&"mp07-moon-palace-approach-v1","kind":&"authored","usefulCellRange":Vector2i(235,235),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(20,12)}]},"featureIds":[&"palace_seal"],"moonpetalInteractions":[{"nodeName":"MoonpetalPalaceSeal","kind":&"palace_seal","cell":Vector2i(10,8)}]},true)
	elif room_id == &"MP-08": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_hall_true_moon.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw"],"navigationId":&"authored:mp08-hall-true-moon-navigation","collisionMaskId":&"authored:mp08-hall-true-moon-collision","navigationLayout":{"id":&"mp08-hall-true-moon-v1","kind":&"authored","usefulCellRange":Vector2i(389,389),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(22,18)}]},"featureIds":[&"magistrate_enma_boss"]},true)
	elif room_id == &"MP-09": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_tea_garden_unsaid_things.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:mp09-tea-garden-unsaid-things-navigation","collisionMaskId":&"authored:mp09-tea-garden-unsaid-things-collision","navigationLayout":{"id":&"mp09-tea-garden-unsaid-things-v1","kind":&"authored","usefulCellRange":Vector2i(210,210),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(18,12)}]},"featureIds":[&"tea_testimony"]},true)
	elif room_id == &"MP-10": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_koi_reflection_maze.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:mp10-koi-reflection-maze-navigation","collisionMaskId":&"authored:mp10-koi-reflection-maze-collision","navigationLayout":{"id":&"mp10-koi-reflection-maze-v1","kind":&"authored","usefulCellRange":Vector2i(378,378),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(24,16)}]},"featureIds":[&"koi_observation_path"]},true)
	elif room_id == &"MP-11": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_shrine_archive_first_drafts.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:mp11-shrine-archive-first-drafts-navigation","collisionMaskId":&"authored:mp11-shrine-archive-first-drafts-collision","navigationLayout":{"id":&"mp11-shrine-archive-first-drafts-v1","kind":&"authored","usefulCellRange":Vector2i(186,186),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(16,12)}]},"featureIds":[&"archive_screen"]},true)
	elif room_id == &"MP-12": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_yokai_artisan_lane.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:mp12-yokai-artisan-lane-navigation","collisionMaskId":&"authored:mp12-yokai-artisan-lane-collision","navigationLayout":{"id":&"mp12-yokai-artisan-lane-v1","kind":&"authored","usefulCellRange":Vector2i(378,378),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(24,16)}]},"featureIds":[&"artisan_exchange"]},true)
	elif room_id == &"MP-13": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_covered_bell_passage.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"navigationId":&"authored:mp13-covered-bell-passage-navigation","collisionMaskId":&"authored:mp13-covered-bell-passage-collision","navigationLayout":{"id":&"mp13-covered-bell-passage-v1","kind":&"authored","usefulCellRange":Vector2i(236,236),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(20,12)}]},"featureIds":[&"roof_occlusion"]},true)
	elif room_id == &"MP-14": definition.merge({"scenePath":"res://ben_rpg/world/rooms/moonpetal_servants_moonbridge.tscn","worldOrigin":Vector2i(550,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:mp14-servants-moonbridge-navigation","collisionMaskId":&"authored:mp14-servants-moonbridge-collision","navigationLayout":{"id":&"mp14-servants-moonbridge-v1","kind":&"authored","usefulCellRange":Vector2i(106,106),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(14,8)}]},"featureIds":[&"singular_reflection_bridge"]},true)
	elif room_id == &"EM-01": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_cloudstep_landing.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:em01-cloudstep-landing-navigation","collisionMaskId":&"authored:em01-cloudstep-landing-collision","navigationLayout":{"id":&"em01-cloudstep-landing-v1","kind":&"authored","usefulCellRange":Vector2i(347,347),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(22,16)}]}},true)
	elif room_id == &"EM-02": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_petitioners_rise.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:em02-petitioners-rise-navigation","collisionMaskId":&"authored:em02-petitioners-rise-collision","navigationLayout":{"id":&"em02-petitioners-rise-v1","kind":&"authored","usefulCellRange":Vector2i(211,211),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(18,12)}]}},true)
	elif room_id == &"EM-03": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_garden_appeals.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"navigationId":&"authored:em03-garden-appeals-navigation","collisionMaskId":&"authored:em03-garden-appeals-collision","navigationLayout":{"id":&"em03-garden-appeals-v1","kind":&"authored","usefulCellRange":Vector2i(412,412),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(26,16)}]},"empyrealInteractions":[{"nodeName":"EmpyrealGravityOrdinance","kind":&"gravity_ordinance","cell":Vector2i(16,6)}],"universeTreasures":[{"nodeName":"EmpyrealGardenTreasure","cacheId":&"empyreal_tithe_basin","cell":Vector2i(14,8)}]},true)
	elif room_id == &"EM-04": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_forum_measures.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"navigationId":&"authored:em04-forum-measures-navigation","collisionMaskId":&"authored:em04-forum-measures-collision","navigationLayout":{"id":&"em04-forum-measures-v1","kind":&"authored","usefulCellRange":Vector2i(392,392),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(22,18)}]}},true)
	elif room_id == &"EM-05": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_counterweight_lift_station.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:em05-counterweight-lift-station-navigation","collisionMaskId":&"authored:em05-counterweight-lift-station-collision","navigationLayout":{"id":&"em05-counterweight-lift-station-v1","kind":&"authored","usefulCellRange":Vector2i(186,186),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(16,12)}]},"featureIds":[&"aerie_seal"],"empyrealInteractions":[{"nodeName":"EmpyrealAerieSeal","kind":&"aerie_seal","cell":Vector2i(9,8)}]},true)
	elif room_id == &"EM-06": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_reliquary_causeway.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:em06-reliquary-causeway-navigation","collisionMaskId":&"authored:em06-reliquary-causeway-collision","navigationLayout":{"id":&"em06-reliquary-causeway-v1","kind":&"authored","usefulCellRange":Vector2i(379,379),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(24,16)}]},"featureIds":[&"gravity_thresholds"]},true)
	elif room_id == &"EM-07": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_reliquary_aerie.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2",&"Se"],"navigationId":&"authored:em07-reliquary-aerie-navigation","collisionMaskId":&"authored:em07-reliquary-aerie-collision","navigationLayout":{"id":&"em07-reliquary-aerie-v1","kind":&"authored","usefulCellRange":Vector2i(413,413),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(26,16)}]},"featureIds":[&"repossession_ambush"],"empyrealInteractions":[{"nodeName":"EmpyrealSaveFountain","kind":&"save_fountain","savePointId":&"empyreal_aerie","cell":Vector2i(11,11)}]},true)
	elif room_id == &"EM-08": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_tribunal_descent.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1"],"navigationId":&"authored:em08-tribunal-descent-navigation","collisionMaskId":&"authored:em08-tribunal-descent-collision","navigationLayout":{"id":&"em08-tribunal-descent-v1","kind":&"authored","usefulCellRange":Vector2i(211,211),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(18,12)}]},"featureIds":[&"tribunal_seal"],"empyrealInteractions":[{"nodeName":"EmpyrealTribunalSeal","kind":&"tribunal_seal","cell":Vector2i(9,8)}]},true)
	elif room_id == &"EM-09": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_seraph_tribunal.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:em09-seraph-tribunal-navigation","collisionMaskId":&"authored:em09-seraph-tribunal-collision","navigationLayout":{"id":&"em09-seraph-tribunal-v1","kind":&"authored","usefulCellRange":Vector2i(390,390),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(22,18)}]},"featureIds":[&"high_comptroller_boss"]},true)
	elif room_id == &"EM-10": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_weather_clerks_terrace.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:em10-weather-clerks-terrace-navigation","collisionMaskId":&"authored:em10-weather-clerks-terrace-collision","navigationLayout":{"id":&"em10-weather-clerks-terrace-v1","kind":&"authored","usefulCellRange":Vector2i(186,186),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(16,12)}]},"featureIds":[&"weather_vanes"]},true)
	elif room_id == &"EM-11": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_archive_lost_appeals.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:em11-archive-lost-appeals-navigation","collisionMaskId":&"authored:em11-archive-lost-appeals-collision","navigationLayout":{"id":&"em11-archive-lost-appeals-v1","kind":&"authored","usefulCellRange":Vector2i(210,210),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(18,12)}]},"featureIds":[&"archive_balance"]},true)
	elif room_id == &"EM-12": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_wing_repossession_yard.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:em12-wing-repossession-yard-navigation","collisionMaskId":&"authored:em12-wing-repossession-yard-collision","navigationLayout":{"id":&"em12-wing-repossession-yard-v1","kind":&"authored","usefulCellRange":Vector2i(378,378),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(24,16)}]},"featureIds":[&"yard_latch"]},true)
	elif room_id == &"EM-13": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_ambassadors_aerie.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw"],"navigationId":&"authored:em13-ambassadors-aerie-navigation","collisionMaskId":&"authored:em13-ambassadors-aerie-collision","navigationLayout":{"id":&"em13-ambassadors-aerie-v1","kind":&"authored","usefulCellRange":Vector2i(185,185),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(16,12)}]},"featureIds":[&"formation_reward"]},true)
	elif room_id == &"EM-14": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_cloudbreak_reliquary_vault.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw"],"navigationId":&"authored:em14-cloudbreak-reliquary-vault-navigation","collisionMaskId":&"authored:em14-cloudbreak-reliquary-vault-collision","navigationLayout":{"id":&"em14-cloudbreak-reliquary-vault-v1","kind":&"authored","usefulCellRange":Vector2i(209,209),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(18,12)}]},"featureIds":[&"three_reliquary_sigils"]},true)
	elif room_id == &"EM-15": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_gravity_inversion_cloister.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne",&"E1",&"E2"],"navigationId":&"authored:em15-gravity-inversion-cloister-navigation","collisionMaskId":&"authored:em15-gravity-inversion-cloister-collision","navigationLayout":{"id":&"em15-gravity-inversion-cloister-v1","kind":&"authored","usefulCellRange":Vector2i(236,236),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(20,12)}]},"featureIds":[&"safe_gravity_route"]},true)
	elif room_id == &"EM-16": definition.merge({"scenePath":"res://ben_rpg/world/rooms/empyreal_public_cloud_ferry.tscn","worldOrigin":Vector2i(600,0),"enabledPortIds":[&"Nw",&"Ne"],"navigationId":&"authored:em16-public-cloud-ferry-navigation","collisionMaskId":&"authored:em16-public-cloud-ferry-collision","navigationLayout":{"id":&"em16-public-cloud-ferry-v1","kind":&"authored","usefulCellRange":Vector2i(106,106),"walkableRects":[{"origin":Vector2i(1,1),"size":Vector2i(14,8)}]},"featureIds":[&"postgame_cloud_ferry"]},true)
	elif room_id == &"PV-01":
		...
		definition.merge({"scenePath": "res://ben_rpg/world/rooms/primeval_lava_tube_bypass.tscn", "worldOrigin": Vector2i(400, 0), "enabledPortIds": [&"Nw", &"Ne", &"E1"], "portGates": {&"Ne": &"primeval_terminal_decoded", &"E1": &"primeval_caldera_open"}, "navigationId": &"authored:pv14-lava-tube-bypass-navigation", "collisionMaskId": &"authored:pv14-lava-tube-bypass-collision", "navigationLayout": {"id": &"pv14-lava-tube-bypass-v1", "kind": &"authored", "usefulCellRange": Vector2i(71, 73), "walkableRects": [{"origin": Vector2i(4, 1), "size": Vector2i(8, 3)}, {"origin": Vector2i(2, 3), "size": Vector2i(12, 4)}, {"origin": Vector2i(4, 6), "size": Vector2i(8, 2)}]}, "featureIds": [&"fossilized_service_tunnel", &"green_traffic_doors", &"stabilized_shortcut"]}, true)
	elif room_id == &"PV-09":
		...
		definition.merge({"scenePath": "res://ben_rpg/world/rooms/primeval_river_switchbacks.tscn", "worldOrigin": Vector2i(400, 0), "enabledPortIds": [&"Nw", &"Ne", &"E1", &"E2"], "portGates": {&"Nw": &"primeval_terminal_decoded", &"E1": &"primeval_terminal_decoded"}, "navigationId": &"authored:pv13-river-switchbacks-navigation", "collisionMaskId": &"authored:pv13-river-switchbacks-collision", "navigationLayout": {"id": &"pv13-river-switchbacks-v1", "kind": &"authored", "usefulCellRange": Vector2i(141, 143), "walkableRects": [{"origin": Vector2i(5, 1), "size": Vector2i(9, 4)}, {"origin": Vector2i(3, 4), "size": Vector2i(12, 7)}, {"origin": Vector2i(15, 3), "size": Vector2i(2, 8)}, {"origin": Vector2i(5, 10), "size": Vector2i(9, 3)}]}, "featureIds": [&"stepping_stones", &"vine_return_cut", &"encounter_light_return"]}, true)
	elif room_id == &"AS-01":
		definition.merge({
		...
		definition.merge({
			...
			"navigationLayout": {"id": &"hm11-mourning-chapel-v1", "kind": &"authored", "usefulCellRange": Vector2i(136, 137), "walkableRects": [{"origin": Vector2i(5, 1), "size": Vector2i(12, 4)}, {"origin": Vector2i(3, 4), "size": Vector2i(16, 6)}, {"origin": Vector2i(18, 3), "size": Vector2i(2, 3)}]},
