...
func _ready() -> void:
	...
	for room_id in [&"HE-01", &"HE-02", &"HE-03", &"HE-04", &"HE-05", &"HE-06", &"HE-07", &"HE-08", &"HE-13"]:
	...
	assert(StringName(ROUTER.resolve(&"HE-13", &"Ne").get("destinationRoom", &"")) == &"HE-04")
	...
	print("CAMPAIGN_HELIOS_ENTRY_SMOKE_OK rooms=HE-01..HE-08+HE-13 art=approved_quadrants")
	get_tree().quit()
