...
func _ready() -> void:
	...
	assert(FIELD_SCALE.FIELD_CHARACTER_VISIBLE_HEIGHT == Vector2i(42, 72))
	assert(FIELD_SCALE.is_visible_height_in_range(42))
	assert(FIELD_SCALE.is_visible_height_in_range(72))
	assert(not FIELD_SCALE.is_visible_height_in_range(41))
	assert(FIELD_SCALE.semantic_size_range(&"doorway") == Vector2i(36, 96))
	assert(FIELD_SCALE.is_semantic_height_in_range(&"boss", 192))
	assert(not FIELD_SCALE.is_semantic_height_in_range(&"boss", 72))
	...
	assert(FIELD_SCALE.is_approved_field_render_scale(0.5))
	assert(FIELD_SCALE.is_approved_field_render_scale(3.0))
	assert(not FIELD_SCALE.is_approved_field_render_scale(0.75))
	assert(FIELD_SCALE.matching_field_render_scale(Vector2i(187, 260), Vector2i(94, 130)) == 0.5)
	assert(FIELD_SCALE.matching_field_render_scale(Vector2i(88, 96), Vector2i(66, 72)) == 0.0)
	assert(FIELD_SCALE.scaled_anchor(Vector2(93, 259), 0.5) == Vector2(47, 130))
