...
| M1 — Visual foundation | In progress | `FIELD_SCALE_BIBLE.md`, 322 visual profiles, runtime inventory/provenance generators, layered field registry, eight foreground scripts, camera rounding, and focused smoke tests exist | Vertical-slice profile coverage is not 100%; 138/162 static runtime textures are profiled; native-scale review and camera/resolution sign-off remain open |
